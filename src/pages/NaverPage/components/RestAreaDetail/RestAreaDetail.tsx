...
const RestAreaDetail = ({ restAreaId, onClose }: Props) => {
  ...
  return (
    <div className="relative flex h-full w-full max-w-[420px] flex-col gap-4 overflow-hidden rounded-xl bg-white p-[10px]">
      {/* X 버튼 */}
      <button
      ...
      {/* 스크롤 가능한 컨텐츠 영역 */}
      <div className="flex h-full flex-col gap-4 overflow-y-auto pt-2">
        {/* 대표 이미지 16:9 + 오버레이 */}
        ...
        {/* 기타 정보/링크 */}
        <div className="flex flex-col gap-4 px-1 pb-4 pt-2">
