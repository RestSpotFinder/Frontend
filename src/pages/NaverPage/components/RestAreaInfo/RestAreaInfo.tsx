...
const RestAreaInfo = ({
  ...
  return (
    <div className="relative box-border flex h-full flex-col overflow-hidden">
      ...
      <div className="scrollbar-thin scrollbar-thumb-[#c1c1c1] scrollbar-track-[#f1f1f1] flex-1 overflow-y-auto">
        {isFetching ? (
          <Loading />
        ) : (
          <>
